...
package team.idealstate.sugar.next.command.example;
...
public final class ExampleCommand implements Command {
    ...
    @NotNull
    public List<String> completeId(@NotNull CommandContext context, @NotNull String argument) {
        if (argument.isEmpty()) {
            return ids;
        }
        return ids.stream()
    ...
    @NotNull
    public ConverterResult<Integer> convertToInt(
