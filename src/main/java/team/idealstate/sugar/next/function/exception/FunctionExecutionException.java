...
package team.idealstate.sugar.next.function.exception;

import team.idealstate.sugar.next.exception.SugarNextException;

public class FunctionExecutionException extends SugarNextException {
    private static final long serialVersionUID = -6371728143331531638L;
    ...
    protected FunctionExecutionException(
