...
public interface TransactionManager {
    ...
    @NotNull
    default TransactionSession openTransaction() {
        return openTransaction(
                DatabaseSessionFactory.DEFAULT_EXECUTION_MODE, DatabaseSessionFactory.DEFAULT_ISOLATION_LEVEL);
    }
     ...
     */
    @NotNull
    TransactionSession openTransaction(int executionMode, int isolationLevel);
     ...
     */
    @NotNull
    <T> T getRepository(@NotNull Class<T> repositoryType) throws TransactionException;
}
