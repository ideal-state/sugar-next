...
import static team.idealstate.sugar.next.reflect.Reflection.annotation;
...
public interface JavaAnnotation extends Java<Annotation> {
    ...
    default <R extends Annotation> R java(@Nullable ClassLoader classLoader) throws BytecodeException {
        ...
        return (R) annotation((Class<? extends Annotation>) getAnnotationType().java(classLoader), mappings);
    }

    @NotNull
    JavaClass getAnnotationType();

    @Nullable
    JavaAnnotatedElement getAnnotatedElement();
    ...
    @NotNull
    default Map<String, Object> getMappings() {
