...
public interface Java<T> {
    ...
    @NotNull
    static JavaClass typeof(@NotNull Class<?> cls) throws BytecodeParsingException {
    ...
    @NotNull
    static JavaClass typeof(@NotNull Object object, @NotNull JavaCache cache) throws BytecodeParsingException {
        return typeof(object.getClass(), cache);
    }

    @NotNull
    static JavaClass typeof(@NotNull Class<?> cls, @NotNull JavaCache cache) throws BytecodeParsingException {
        return typeof(cls.getName(), cache);
    }

    @NotNull
    static JavaClass typeof(@NotNull String className, @NotNull JavaCache cache) throws BytecodeParsingException {
        return typeof(className, cache, null);
    }

    @NotNull
    static JavaClass typeof(@NotNull Object object, @NotNull JavaCache cache, ClassLoader classLoader)
    ...
    @NotNull
    static JavaClass typeof(@NotNull Class<?> cls, @NotNull JavaCache cache, ClassLoader classLoader)
            throws BytecodeParsingException {
    ...
    @NotNull
    static JavaClass typeof(@NotNull String className, @NotNull JavaCache cache, ClassLoader classLoader)
            throws BytecodeParsingException {
