...
public interface JavaPackage extends Java<Package>, JavaAnnotatedElement {

    @NotNull
    @Override
    @SuppressWarnings({"unchecked"})
    default <R extends Package> R java(@Nullable ClassLoader classLoader) throws BytecodeException {
        return (R) Package.getPackage(getName());
    }
