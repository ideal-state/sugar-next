...
package team.idealstate.sugar.next.context.exception;

import team.idealstate.sugar.next.exception.SugarNextException;

public class ContextException extends SugarNextException {
    private static final long serialVersionUID = 1729989485087305084L;
