...
import team.idealstate.minecraft.next.common.reflect.annotation.ReflectConstructor;
import team.idealstate.minecraft.next.common.reflect.annotation.ReflectField;
...
class InternalReflectionHandler implements ReflectionInvocationHandler {
    ...
    InternalReflectionHandler(
            @NotNull ClassLoader classLoader,
            @NotNull Class<?> reflectionInterface,
            Object target) {
    ...
    @NotNull private static Class<?> getDeclaringClass(
        ...
        if (cls == null || void.class.equals(cls)) {
            try {
                ...
                return getDeclaringClass(
                        defaultClass.value(), defaultClass.name(), classLoader, null);
            }
        }
        return cls;
    }

    @NotNull private static MethodHandles.Lookup lookup(boolean accessible) {
                        ...
                        key -> {
                            ...
                            for (Annotation annotation : annotations) {
                                ...
                                if (ReflectConstructor.class.equals(annotationType)) {
                                    ReflectConstructor reflectConstructor =
                                            (ReflectConstructor) annotation;
                                    return new ReflectConstructorHandler(
                                            reflect, reflectConstructor);
                            ...
                            if (method.isDefault()) {
                                if (specialLookup == null) {
                                    this.specialLookup =
                                            InternalMethodHandles.privateLookup(
                    ...
                    if (defaultMethod == null) {
                        try {
                            MethodHandle methodHandle =
                                    specialLookup.unreflectSpecial(
                    ...
                    if (constructor == null) {
                        try {
                            Class<?> declaringClass =
                                    InternalReflectionHandler.getDeclaringClass(
                            ...
                            this.constructor =
                                    InternalReflectionHandler.lookup(
                                                    reflectConstructor.accessible())
        ...
        private static boolean isSetter(Method method, Object[] args, Field field) {
            ...
            if (args != null && args.length > 0) {
                ...
                if (!field.getType().isAssignableFrom(method.getParameterTypes()[0])) {
                    throw new ReflectionException(
                            "Field type must be assignable from argument type.");
                }
                isSetter = true;
            }
            return isSetter;
                    ...
                    if (field == null) {
                        try {
                            ...
                            if (isGetter
                                ...
                                throw new ReflectionException(
                                        "Return type of field must be assignable from target field"
                                                + " type.");
                            }
                            ...
                            MethodHandles.Lookup lookup =
                                    InternalReflectionHandler.lookup(accessible);
                        ...
                        try {
                            ...
                            Method _method =
                                    declaringClass.getDeclaredMethod(
                                            memberName, method.getParameterTypes());
                            if (!method.getReturnType().isAssignableFrom(_method.getReturnType())) {
                                throw new ReflectionException(
                                        "Return type of method must be assignable from target"
                                                + " method return type.");
                            }
