...
package team.idealstate.minecraft.next.common.context.boot.mybatis.cache;
...
import team.idealstate.minecraft.next.common.context.ContextProperty;
...
import team.idealstate.minecraft.next.common.context.annotation.feature.DependsOn.Property;
import team.idealstate.minecraft.next.common.context.aware.ContextAware;
import team.idealstate.minecraft.next.common.context.boot.jedis.NextJedis;
...
@DependsOn(
        ...
        classes = {
            "team.idealstate.minecraft.next.common.context.boot.jedis.NextJedis",
            "team.idealstate.minecraft.next.common.context.boot.mybatis.NextMyBatis"
        },
        properties = {
            @Property(
                    key =
                            "team.idealstate.minecraft.next.common.context.boot.jedis.annotation.EnableJedis",
                    strict = false),
            @Property(
                    key =
                            "team.idealstate.minecraft.next.common.context.boot.mybatis.annotation.EnableMyBatis",
                    strict = false)
        })
public class JedisMyBatisCache implements Cache, ContextAware, Initializable {
    ...
    public Object getObject(final Object key) {
        return execute(
                jedis -> deserialize(jedis.hget(getId().getBytes(), key.toString().getBytes())));
    }
    ...
    public void initialize() {
        ...
        this.charset =
                property == null ? StandardCharsets.UTF_8 : Charset.forName(property.getValue());
    }
