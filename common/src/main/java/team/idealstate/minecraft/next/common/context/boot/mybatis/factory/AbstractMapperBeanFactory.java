...
import team.idealstate.minecraft.next.common.context.factory.AbstractBeanFactory;
import team.idealstate.minecraft.next.common.database.TransactionManager;
import team.idealstate.minecraft.next.common.validate.Validation;
import team.idealstate.minecraft.next.common.validate.annotation.NotNull;

public abstract class AbstractMapperBeanFactory<M extends Annotation>
    ...
    protected <T> T doCreate(
        ...
        TransactionManager transactionManager =
                TransactionComponentBeanFactory.getTransactionManager(context);
        Class<?> proxyType =
                functional(
                                new ByteBuddy()
                                        .subclass(marked)
                                        ...
                                        .intercept(
                                                MethodDelegation.to(
                                                        new MapperInterceptor(
                                                                transactionManager, marked)))
                                        .make())
                        .use(
                                Class.class,
    ...
    protected static final class MapperInterceptor {
        ...
        public Object intercept(@Origin MethodHandle methodHandle, @AllArguments Object[] arguments)
                throws Throwable {
