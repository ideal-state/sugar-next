...
package team.idealstate.minecraft.next.common.context.boot.hikaricp;
...
public class HikariCP implements NextHikariCP, ContextAware, Initializable, Destroyable {
                ...
                lazy(
                        () -> {
                            ...
                            if (path instanceof String && ((String) path).startsWith(".")) {
                                String absolutePath =
                                        new File(getContext().getDataFolder(), (String) path)
                                                .getAbsolutePath();
    ...
    @NotNull private Lazy<HikariDataSource> getLazyDataSource() {
        return Validation.requireNotNull(this.lazyDataSource, "lazy data source must not be null.");
    }

    @NotNull private static HikariConfig asHikariConfig(HikariCPConfiguration configuration) {
    ...
    @NotNull private HikariCPConfiguration getConfiguration() {
