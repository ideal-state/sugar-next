...
package team.idealstate.minecraft.next.common.bytecode.exception;

public class BytecodeException extends RuntimeException {
    private static final long serialVersionUID = -7180065404539710736L;
