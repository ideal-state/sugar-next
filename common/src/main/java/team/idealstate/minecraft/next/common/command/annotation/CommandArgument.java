...
public @interface CommandArgument {
     ...
     *     ExampleCommand#completeId(CommandContext, String)}）， 值为 "" 时将使用 {@link #completerType()}
    ...
    final class ConverterResult<T> {
        ...
        @NotNull public static <T> ConverterResult<T> success() {
            return success(null);
        }

        @NotNull public static <T> ConverterResult<T> success(T result) {
            return new ConverterResult<>(true, result);
        }

        @NotNull public static <T> ConverterResult<T> failure() {
            return failure(null);
        }

        @NotNull public static <T> ConverterResult<T> failure(T result) {
