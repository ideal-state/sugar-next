# <img align="left" src="logo.svg" height="192px" alt="logo"/> Minecraft Next
...
```shell
# 1. 克隆项目到本地
git clone https://gitlab.com/ideal-state/minecraft-next.git
# 2. 进入项目根目录
cd ./minecraft-next
# 3. 构建项目
./gradlew assemble
